...
const UserTable = () => {
  ...
  const saveEdit = async () => {
    try {
      await fetch(`https://urmila-webservice.onrender.com/admin/users/${editingUser._id}`, {
        method: "PUT",
  ...
  const fetchUsers = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `https://urmila-webservice.onrender.com/admin/users?${query.toString()}`
      );
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await fetch(`https://urmila-webservice.onrender.com/admin/users/${id}`, {
        method: "DELETE",
      });
      fetchUsers(); // Refresh the user list
    } catch (error) {
